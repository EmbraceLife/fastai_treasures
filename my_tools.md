...
<div class="toc"><ul class="toc-item"><li><span><a href="#My-toolbox-我的本地设置" data-toc-modified-id="My-toolbox-我的本地设置-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>My toolbox 我的本地设置</a></span><ul class="toc-item"><li><span><a href="#Recent-found-resources" data-toc-modified-id="Recent-found-resources-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Recent found resources</a></span></li></ul></li><li><span><a href="#Terminal-basics" data-toc-modified-id="Terminal-basics-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Terminal basics</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#How-to-copy-a-whole-folder-to-another-folder" data-toc-modified-id="How-to-copy-a-whole-folder-to-another-folder-2.0.1"><span class="toc-item-num">2.0.1&nbsp;&nbsp;</span>How to copy a whole folder to another folder</a></span></li><li><span><a href="#remove-a-folder-or-a-file" data-toc-modified-id="remove-a-folder-or-a-file-2.0.2"><span class="toc-item-num">2.0.2&nbsp;&nbsp;</span>remove a folder or a file</a></span></li><li><span><a href="#如何在iterm2中切屏分屏跳跃" data-toc-modified-id="如何在iterm2中切屏分屏跳跃-2.0.3"><span class="toc-item-num">2.0.3&nbsp;&nbsp;</span>如何在iterm2中切屏分屏跳跃</a></span></li><li><span><a href="#最常用的terminal-commands" data-toc-modified-id="最常用的terminal-commands-2.0.4"><span class="toc-item-num">2.0.4&nbsp;&nbsp;</span>最常用的terminal commands</a></span></li><li><span><a href="#构建bash_profile" data-toc-modified-id="构建bash_profile-2.0.5"><span class="toc-item-num">2.0.5&nbsp;&nbsp;</span>构建bash_profile</a></span></li></ul></li></ul></li><li><span><a href="#Vim-basics" data-toc-modified-id="Vim-basics-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Vim basics</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#comment-out" data-toc-modified-id="comment-out-3.0.1"><span class="toc-item-num">3.0.1&nbsp;&nbsp;</span>comment out</a></span></li><li><span><a href="#unlimited-undos" data-toc-modified-id="unlimited-undos-3.0.2"><span class="toc-item-num">3.0.2&nbsp;&nbsp;</span>unlimited undos</a></span></li><li><span><a href="#see-changes-recently-made-to-a-file" data-toc-modified-id="see-changes-recently-made-to-a-file-3.0.3"><span class="toc-item-num">3.0.3&nbsp;&nbsp;</span>see changes recently made to a file</a></span></li><li><span><a href="#to-copy-a-line-from-one-file-to-another" data-toc-modified-id="to-copy-a-line-from-one-file-to-another-3.0.4"><span class="toc-item-num">3.0.4&nbsp;&nbsp;</span>to copy a line from one file to another</a></span></li><li><span><a href="#to-delete-a-word" data-toc-modified-id="to-delete-a-word-3.0.5"><span class="toc-item-num">3.0.5&nbsp;&nbsp;</span>to delete a word</a></span></li><li><span><a href="#copy-or-replace-a-line" data-toc-modified-id="copy-or-replace-a-line-3.0.6"><span class="toc-item-num">3.0.6&nbsp;&nbsp;</span>copy or replace a line</a></span></li><li><span><a href="#copy-a-word" data-toc-modified-id="copy-a-word-3.0.7"><span class="toc-item-num">3.0.7&nbsp;&nbsp;</span>copy a word</a></span></li><li><span><a href="#repeat-commands" data-toc-modified-id="repeat-commands-3.0.8"><span class="toc-item-num">3.0.8&nbsp;&nbsp;</span>repeat commands</a></span></li><li><span><a href="#Search-multiple-files-with-fzf-and-ag" data-toc-modified-id="Search-multiple-files-with-fzf-and-ag-3.0.9"><span class="toc-item-num">3.0.9&nbsp;&nbsp;</span>Search multiple files with <code>fzf</code> and <code>ag</code></a></span></li><li><span><a href="#Search-multiple-files-with-grep" data-toc-modified-id="Search-multiple-files-with-grep-3.0.10"><span class="toc-item-num">3.0.10&nbsp;&nbsp;</span>Search multiple files with <code>grep</code></a></span></li><li><span><a href="#vim-switching-locations-and-commands" data-toc-modified-id="vim-switching-locations-and-commands-3.0.11"><span class="toc-item-num">3.0.11&nbsp;&nbsp;</span>vim switching locations and commands</a></span></li><li><span><a href="#install-kite-for-vim" data-toc-modified-id="install-kite-for-vim-3.0.12"><span class="toc-item-num">3.0.12&nbsp;&nbsp;</span>install kite for vim</a></span></li><li><span><a href="#vim-cursor-moving" data-toc-modified-id="vim-cursor-moving-3.0.13"><span class="toc-item-num">3.0.13&nbsp;&nbsp;</span>vim cursor moving</a></span></li><li><span><a href="#Vim-kick-start" data-toc-modified-id="Vim-kick-start-3.0.14"><span class="toc-item-num">3.0.14&nbsp;&nbsp;</span>Vim kick start</a></span></li><li><span><a href="#vim-如何用上下键跳跃5行代码" data-toc-modified-id="vim-如何用上下键跳跃5行代码-3.0.15"><span class="toc-item-num">3.0.15&nbsp;&nbsp;</span>vim 如何用上下键跳跃5行代码</a></span></li><li><span><a href="#用vim找pdbpp中运行的代码-vim-find-codelines-in-pdbpp" data-toc-modified-id="用vim找pdbpp中运行的代码-vim-find-codelines-in-pdbpp-3.0.16"><span class="toc-item-num">3.0.16&nbsp;&nbsp;</span>用vim找pdbpp中运行的代码 vim find codelines in pdbpp</a></span></li><li><span><a href="#vim如何剪切，复制，粘贴，保存" data-toc-modified-id="vim如何剪切，复制，粘贴，保存-3.0.17"><span class="toc-item-num">3.0.17&nbsp;&nbsp;</span>vim如何剪切，复制，粘贴，保存</a></span></li><li><span><a href="#如何做vim常规搜索" data-toc-modified-id="如何做vim常规搜索-3.0.18"><span class="toc-item-num">3.0.18&nbsp;&nbsp;</span>如何做vim常规搜索</a></span></li><li><span><a href="#vim如何对文件夹做tag" data-toc-modified-id="vim如何对文件夹做tag-3.0.19"><span class="toc-item-num">3.0.19&nbsp;&nbsp;</span>vim如何对文件夹做tag</a></span></li><li><span><a href="#Explore-source-code,-split-screen,-vim" data-toc-modified-id="Explore-source-code,-split-screen,-vim-3.0.20"><span class="toc-item-num">3.0.20&nbsp;&nbsp;</span>Explore source code, split screen, vim</a></span></li><li><span><a href="#vim-如何寻找文件和文件夹搜索" data-toc-modified-id="vim-如何寻找文件和文件夹搜索-3.0.21"><span class="toc-item-num">3.0.21&nbsp;&nbsp;</span>vim 如何寻找文件和文件夹搜索</a></span></li><li><span><a href="#vim-如何展开和折叠" data-toc-modified-id="vim-如何展开和折叠-3.0.22"><span class="toc-item-num">3.0.22&nbsp;&nbsp;</span>vim 如何展开和折叠</a></span></li><li><span><a href="#vim-如何知道当前所在文件地址" data-toc-modified-id="vim-如何知道当前所在文件地址-3.0.23"><span class="toc-item-num">3.0.23&nbsp;&nbsp;</span>vim 如何知道当前所在文件地址</a></span></li><li><span><a href="#安装下载-vim" data-toc-modified-id="安装下载-vim-3.0.24"><span class="toc-item-num">3.0.24&nbsp;&nbsp;</span>安装下载 vim</a></span></li><li><span><a href="#设置-vim-source" data-toc-modified-id="设置-vim-source-3.0.25"><span class="toc-item-num">3.0.25&nbsp;&nbsp;</span>设置 vim source</a></span></li><li><span><a href="#安装-ctags" data-toc-modified-id="安装-ctags-3.0.26"><span class="toc-item-num">3.0.26&nbsp;&nbsp;</span>安装 ctags</a></span></li><li><span><a href="#.vimrc-file" data-toc-modified-id=".vimrc-file-3.0.27"><span class="toc-item-num">3.0.27&nbsp;&nbsp;</span>.vimrc file</a></span></li></ul></li></ul></li><li><span><a href="#Git-basics" data-toc-modified-id="Git-basics-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>Git basics</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#How-to-push-a-local-folder-to-a-remote-git-repo" data-toc-modified-id="How-to-push-a-local-folder-to-a-remote-git-repo-4.0.1"><span class="toc-item-num">4.0.1&nbsp;&nbsp;</span>How to push a local folder to a remote git repo</a></span></li><li><span><a href="#How-to-resolve-conflict-in-git" data-toc-modified-id="How-to-resolve-conflict-in-git-4.0.2"><span class="toc-item-num">4.0.2&nbsp;&nbsp;</span>How to resolve conflict in git</a></span></li><li><span><a href="#check-out-the-difference" data-toc-modified-id="check-out-the-difference-4.0.3"><span class="toc-item-num">4.0.3&nbsp;&nbsp;</span>check out the difference</a></span></li><li><span><a href="#How-to-change-commit-messages" data-toc-modified-id="How-to-change-commit-messages-4.0.4"><span class="toc-item-num">4.0.4&nbsp;&nbsp;</span>How to change commit messages</a></span><ul class="toc-item"><li><span><a href="#before-push-it" data-toc-modified-id="before-push-it-4.0.4.1"><span class="toc-item-num">4.0.4.1&nbsp;&nbsp;</span>before push it</a></span></li><li><span><a href="#after-push-it" data-toc-modified-id="after-push-it-4.0.4.2"><span class="toc-item-num">4.0.4.2&nbsp;&nbsp;</span>after push it</a></span></li><li><span><a href="#older-commit" data-toc-modified-id="older-commit-4.0.4.3"><span class="toc-item-num">4.0.4.3&nbsp;&nbsp;</span>older commit</a></span></li></ul></li><li><span><a href="#Encountered-problems" data-toc-modified-id="Encountered-problems-4.0.5"><span class="toc-item-num">4.0.5&nbsp;&nbsp;</span>Encountered problems</a></span></li><li><span><a href="#如何使用git-merge" data-toc-modified-id="如何使用git-merge-4.0.6"><span class="toc-item-num">4.0.6&nbsp;&nbsp;</span>如何使用git merge</a></span></li><li><span><a href="#如何撤回本地和推送的commit" data-toc-modified-id="如何撤回本地和推送的commit-4.0.7"><span class="toc-item-num">4.0.7&nbsp;&nbsp;</span>如何撤回本地和推送的commit</a></span></li><li><span><a href="#如何免去用户名和密码" data-toc-modified-id="如何免去用户名和密码-4.0.8"><span class="toc-item-num">4.0.8&nbsp;&nbsp;</span>如何免去用户名和密码</a></span></li><li><span><a href="#如何快速git-push" data-toc-modified-id="如何快速git-push-4.0.9"><span class="toc-item-num">4.0.9&nbsp;&nbsp;</span>如何快速git push</a></span></li><li><span><a href="#如何在原fastai-repo和你的fork-repo之间更新？" data-toc-modified-id="如何在原fastai-repo和你的fork-repo之间更新？-4.0.10"><span class="toc-item-num">4.0.10&nbsp;&nbsp;</span>如何在原fastai repo和你的fork repo之间更新？</a></span></li><li><span><a href="#如何创建git-branch,-make-changes-and-git-push-to-cloud" data-toc-modified-id="如何创建git-branch,-make-changes-and-git-push-to-cloud-4.0.11"><span class="toc-item-num">4.0.11&nbsp;&nbsp;</span>如何创建git branch, make changes and git push to cloud</a></span></li></ul></li></ul></li><li><span><a href="#PDBPP-basics" data-toc-modified-id="PDBPP-basics-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>PDBPP basics</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#.pdbrc" data-toc-modified-id=".pdbrc-5.0.1"><span class="toc-item-num">5.0.1&nbsp;&nbsp;</span>.pdbrc</a></span></li><li><span><a href="#.pdbrc.py" data-toc-modified-id=".pdbrc.py-5.0.2"><span class="toc-item-num">5.0.2&nbsp;&nbsp;</span>.pdbrc.py</a></span></li></ul></li></ul></li><li><span><a href="#Video" data-toc-modified-id="Video-6"><span class="toc-item-num">6&nbsp;&nbsp;</span>Video</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#youtube-dl" data-toc-modified-id="youtube-dl-6.0.1"><span class="toc-item-num">6.0.1&nbsp;&nbsp;</span>youtube-dl</a></span></li><li><span><a href="#Monosnap-for-video" data-toc-modified-id="Monosnap-for-video-6.0.2"><span class="toc-item-num">6.0.2&nbsp;&nbsp;</span>Monosnap for video</a></span></li><li><span><a href="#如何将youtube-sbv字幕转化为srt" data-toc-modified-id="如何将youtube-sbv字幕转化为srt-6.0.3"><span class="toc-item-num">6.0.3&nbsp;&nbsp;</span>如何将youtube sbv字幕转化为srt</a></span></li><li><span><a href="#翻译Youtube字幕常用快捷键" data-toc-modified-id="翻译Youtube字幕常用快捷键-6.0.4"><span class="toc-item-num">6.0.4&nbsp;&nbsp;</span>翻译Youtube字幕常用快捷键</a></span></li><li><span><a href="#如何去除YouTube字幕翻译时的卡顿" data-toc-modified-id="如何去除YouTube字幕翻译时的卡顿-6.0.5"><span class="toc-item-num">6.0.5&nbsp;&nbsp;</span>如何去除YouTube字幕翻译时的卡顿</a></span></li><li><span><a href="#Looper-for-youtube" data-toc-modified-id="Looper-for-youtube-6.0.6"><span class="toc-item-num">6.0.6&nbsp;&nbsp;</span>Looper for youtube</a></span></li><li><span><a href="#如何为视频做语音解说" data-toc-modified-id="如何为视频做语音解说-6.0.7"><span class="toc-item-num">6.0.7&nbsp;&nbsp;</span>如何为视频做语音解说</a></span></li></ul></li></ul></li><li><span><a href="#Jupyter-Notebook-vs-atom" data-toc-modified-id="Jupyter-Notebook-vs-atom-7"><span class="toc-item-num">7&nbsp;&nbsp;</span>Jupyter Notebook vs atom</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#Update-nbviewer-right-away" data-toc-modified-id="Update-nbviewer-right-away-7.0.1"><span class="toc-item-num">7.0.1&nbsp;&nbsp;</span>Update nbviewer right away</a></span></li><li><span><a href="#Jupyter-notebook-extensions" data-toc-modified-id="Jupyter-notebook-extensions-7.0.2"><span class="toc-item-num">7.0.2&nbsp;&nbsp;</span>Jupyter notebook extensions</a></span></li><li><span><a href="#jn-color-theme" data-toc-modified-id="jn-color-theme-7.0.3"><span class="toc-item-num">7.0.3&nbsp;&nbsp;</span>jn color theme</a></span></li><li><span><a href="#use-atom-with-Hydrogen" data-toc-modified-id="use-atom-with-Hydrogen-7.0.4"><span class="toc-item-num">7.0.4&nbsp;&nbsp;</span>use atom with Hydrogen</a></span></li><li><span><a href="#Jupyter-notebook-install" data-toc-modified-id="Jupyter-notebook-install-7.0.5"><span class="toc-item-num">7.0.5&nbsp;&nbsp;</span>Jupyter notebook install</a></span></li></ul></li></ul></li><li><span><a href="#如何安装fastai-workstation" data-toc-modified-id="如何安装fastai-workstation-8"><span class="toc-item-num">8&nbsp;&nbsp;</span>如何安装fastai workstation</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#如何启用-fastai-dev-version" data-toc-modified-id="如何启用-fastai-dev-version-8.0.1"><span class="toc-item-num">8.0.1&nbsp;&nbsp;</span>如何启用 fastai dev version</a></span></li><li><span><a href="#How-to-update-other-dependencies-for-dev-fastai" data-toc-modified-id="How-to-update-other-dependencies-for-dev-fastai-8.0.2"><span class="toc-item-num">8.0.2&nbsp;&nbsp;</span>How to update other dependencies for dev fastai</a></span></li><li><span><a href="#install-pytorch" data-toc-modified-id="install-pytorch-8.0.3"><span class="toc-item-num">8.0.3&nbsp;&nbsp;</span>install pytorch</a></span></li></ul></li></ul></li><li><span><a href="#Conda-Basics" data-toc-modified-id="Conda-Basics-9"><span class="toc-item-num">9&nbsp;&nbsp;</span>Conda Basics</a></span><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#如何使用-pdbpp" data-toc-modified-id="如何使用-pdbpp-9.0.1"><span class="toc-item-num">9.0.1&nbsp;&nbsp;</span>如何使用 pdbpp</a></span></li></ul></li></ul></li><li><span><a href="#Math" data-toc-modified-id="Math-10"><span class="toc-item-num">10&nbsp;&nbsp;</span>Math</a></span><ul class="toc-item"><li><span><a href="#其他参考链接" data-toc-modified-id="其他参考链接-10.1"><span class="toc-item-num">10.1&nbsp;&nbsp;</span>其他参考链接</a></span></li></ul></li></ul></div>
